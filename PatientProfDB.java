...
public abstract class PatientProfDBAbstract {
    ...
    protected final PatientProf getPatientProfObjByIndex(int index) {  return patientList[index];  }
...
public class PatientProfDB extends PatientProfDBAbstract implements Serializable {
    ...
    private static final PatientProf[] addObjElement(PatientProf[] arr, PatientProf s) {
    ...
    protected PatientProf findProfile(String adminID, String name) throws Exception {
        ...
        int indexProfile = super.getPatientProfArrIndex(adminID, name);
    ...
    protected void insertNewProfile(PatientProf profile) {  this.patientList = addObjElement(this.patientList, profile); this.updateNumPatient();  }
